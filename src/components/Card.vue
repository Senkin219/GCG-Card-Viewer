  ...
  <div class="card">
    <div class="cardface" :style="{ backgroundImage: `url(./resources/${characterName}/${characterList[characterName]['bg']})` }">
      ...
      <div
        ...
        :style="{
          width: characterList[characterName]['btn']['width'] ?? '100%',
          height: characterList[characterName]['btn']['height'] ?? '100%',
          left: characterList[characterName]['btn']['left'] ?? '0%',
          bottom: characterList[characterName]['btn']['bottom'] ?? '0%',
          position: 'absolute',
          zIndex: 1,
          opacity: 0,
